...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, D1_Pin|D2_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LD1_Pin D3_Pin D4_Pin LD3_Pin
                           LD2_Pin */
  GPIO_InitStruct.Pin = LD1_Pin|D3_Pin|D4_Pin|LD3_Pin
                          |LD2_Pin;
